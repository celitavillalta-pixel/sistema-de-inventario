...
from eliminacion import pantalla_eliminacion
from editar import editar_producto
...
def principal_keepit(ventana, limpiar_pantalla):
    ...
    boton_1= customtkinter.CTkButton(
        ...
        width= 250,
        height= 40,
        command=lambda: registrar_producto(tarjeta_pantalla_principal, logo_label, boton_1, boton_2, boton_3, boton_editar=boton_editar)
        )
    ...
    def editar_prod():
        limpiar_pantalla()
        editar_producto(ventana, limpiar_pantalla)
