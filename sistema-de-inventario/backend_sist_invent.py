...
def productos_ingresados(entry_codigo, entry_nombre, entry_cantidad, entry_precio, opcion, label_precio, label_cantidad, label_nombre, label_codigo):
    ...
    label_codigo.config(text=f"Código: {codigo}", font=("Segoe UI", "bold", 14), text_color="#00BFFE")
    label_nombre.config(text=f"Nombre: {nombre}", font=("Segoe UI", "bold", 14), text_color="#00BFFE")
    label_cantidad.config(text=f"Cantidad: {cantidad}", font=("Segoe UI", "bold", 14), text_color="#00BFFE")
    label_precio.config(text=f"Precio: ${precio:.2f}", font=("Segoe UI", "bold", 14), text_color="#00BFFE")
