...
def registrar_producto(ventana, logo_label, boton_1, boton_2, boton_3):
    ...
    def volver():
        ventana.destroy()
        # Importar y reiniciar la pantalla principal
        from pantalla_principal_ import pantalla_keepit 
        pantalla_keepit()
   
    boton_volver = ctk.CTkButton(master = tarjeta_registro, text="Volver", bg_color="#E0E0E0", fg_color="#00BFFE", width= 250, height= 40, command=volver)
